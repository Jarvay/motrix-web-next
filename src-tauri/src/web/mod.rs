...
use crate::web::routes::events::{broadcast_stat_update, create_event_broadcast, StatUpdate, SseEvent};
        ...
        loop {
            ...
            match client.get_global_stat().await {
                Ok(raw) => {
                    ...
                    broadcast_stat_update(&tx, StatUpdate {
                        download_speed,
                        upload_speed,
                        num_active,
                        num_waiting,
                    ...
                    if num_active > 0 {
                        ...
                        current_interval = (current_interval + IDLE_INCREMENT_MS)
                            .min(MAX_INTERVAL_MS);
                    }
                }
                Err(_) => {
